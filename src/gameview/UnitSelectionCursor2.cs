...
//        private GameObject myGameObject;
        private GameObject2 myGameObject;
        ...
        public UnitSelectionCursor2(GameObject2 gameObject, int x, int y)
        {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            // GameWorldLocation gameWorldLocation = myGameObject.GameWorldLocation;
            GameWorldLocationDouble gmaWorldLocationDouble = myGameObject.GameWorldLocation;


            selectionCursorPosition = new Vector2(
                (float) (gmaWorldLocationDouble.X + selectionCursorOffset.X),
                (float) (gmaWorldLocationDouble.Y + selectionCursorOffset.Y));
